export default function MikroplastikMission({ mission, onBack }) {
    return (
        <section className="w-screen h-screen bg-cyan-50 flex items-center justify-center p-8">
            <div className="w-full max-w-5xl rounded-3xl bg-white p-8 shadow-xl text-center">
                ...
                <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-blue-600 mb-2">
                    Mission 2
                </p>
                ...
                <p className="text-slate-700 mb-6">
                    Hier kommt die Aufgabe zum Thema Mikroplastik rein.
                </p>
